...
th, td {
  padding: 8px;
  text-align: left;
  border-bottom:  border: 1px solid #dddddd;;
}
...
.bg-img {
  /* The image used */
  background-image: url("http://localhost/CPP/Images/bag1.png");
...
<div class="mycontainer">
  ...
  <div style="background-color:#FFF4A3;">
    <image src="http://localhost/CPP/mail.png" style="width:30px; height:20px;vertical-align:middle;margin:-13px auto;">
        ...
        <a href="02346-250447/48" style="margin-left:380px;margin-bottom:10px;">02346-250447/48</a>
  </div>
...
<br>
<div class="ro" style="margin:20px;">
  <div class="col" style="width:50%">
    <img src="http://localhost/CPP/Images/datewise.png" style="width:500px; border-radius: 15px;">
  </div>
  <div class="col" style="width:50%;background-color: gray;padding: 16px;border-radius: 15px;height:305px">
   <center> <h1 style="color:white">Datewise Report</h1>

       <label for="psw" style="color:white"><b>Date</b></label></center>
    <input type="date" placeholder="Select Date" name="date"  required>

    <button type="submit" class="btn" class="btn">Search</button>
  </div>
</div>
...
<br><br><br><br><center><h2 style="color:#B83C08">Visitor Data</h2>
<table class="result">
  <tr>
    <th>V_Id</th>
    <th>V_Name</th>
...
$rdate = filter_input(INPUT_POST, "date");
...
if ($conn->connect_error) {
    ...
    // Construct the SQL query to fetch data between the start and end dates
    $sql = "SELECT V_Id, V_Name, Gender, City, Category, Mobile, Vehicle_No, Date, Arr_Time, Dept_Time FROM visitors_management WHERE Date= '$rdate' AND Flag=0";
