...
.bg-img {
  /* The image used */
  background-image: url("http://localhost/CPP/Images/itrbg.png");
...
<form action="" method="post">
  ...
  <div class="container"><br><br>
    <label for="uname"><b>Start Date</b></label><br>
    <input type="date" placeholder="Start Date" name="start_date" required><br><br>

    <label for="psw"><b>Last Date</b></label><br>
    <input type="date" placeholder="Last Date" name="last_date" required><br><br><br>
        
    <button type="submit" onclick="scrollto()">Search</button>
...
$sdate = filter_input(INPUT_POST, "start_date");
$ldate = filter_input(INPUT_POST, "last_date");
...
if ($conn->connect_error) {
    ...
    $sql = "SELECT V_Id, V_Name, Gender, City, Category, Mobile, Vehicle_No, Date, Arr_Time, Dept_Time FROM visitors_management WHERE Date BETWEEN '$sdate' AND '$ldate' AND Flag=0";
